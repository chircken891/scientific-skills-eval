...
### 来源A：用户直接提供的 Skill（14个）

| # | 名称 | 描述 | 来源 |
|---|------|------|------|
| A01 | deep-research | PRISMA系统综述 + Socratic引导式（13 agents） | 用户提供 |
| A02 | academic-paper | Style Calibration语言往期刊靠（12 agents） | 用户提供 |
| A03 | paper-reviewer | EIC + 3审稿 + Devil's Advocate量化打分（7 agents） | 用户提供 |
| A04 | academic-pipeline | 串起前三个，每stage有checkpoint（10阶段） | 用户提供 |
| A05 | nature-skills | Nature系列相关 | 用户提供 |
| A06 | Literature Review | 文献综述 | 用户提供 |
| A07 | Citation Management | 引用管理 | 用户提供 |
| A08 | Data Analysis | 数据分析 | 用户提供 |
| A09 | Text Analysis | 文本分析 | 用户提供 |
| A10 | LaTeX Paper Writing | LaTeX论文写作 | 用户提供 |
| A11 | Paper Polishing | 论文润色 | 用户提供 |
| A12 | Experiment Tracking | 实验追踪 | 用户提供 |
