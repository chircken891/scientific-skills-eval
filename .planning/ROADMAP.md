...
Plans:
- [ ] 07-01-PLAN.md — Wave 0: Verification scripts (07-VERIFY.sh) + performance benchmark tool (P6-E01)
- [ ] 07-02-PLAN.md — Wave 1: SKILL.md frontmatter schema (triggers, model, exclude_when) + config files
